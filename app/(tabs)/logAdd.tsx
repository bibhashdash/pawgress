...
import {cn, formatDateTime, isStringBlank} from "@/lib/utils";
    ...
    return (
        <SafeAreaView className="flex-1 bg-background" edges={["bottom", "left", "right"]}>
            ...
            >
                ...
                <Button
                    disabled={
                        isStringBlank(String(selectedCategory))
                        || isStringBlank(String(selectedSubclass))
                        || isStringBlank(String(selectedTag))
                        || isStringBlank(date.toISOString())
                        || isSubmitting
                    }
