...
// Shared add-category form: used as the standalone "Add Behaviour Class"
// screen and embedded inside the onboarding carousel's bottom sheet.
export function BehaviourClassAddForm({onCreated, onError}: {
    onCreated: (id: Id<"behaviourClasses">) => void,
    onError?: () => void,
}) {
